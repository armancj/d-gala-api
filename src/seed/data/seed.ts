...
import { SeedData } from '../interface/seed.interface';
import { ValidTypes } from '../enum/seed.enum';

const sizes = ['XS', 'S', 'M', 'L', 'XL', 'XXL'];

const component = [
  'Sole: rubber (30-50%), leather (20-40%), plastic (10-30%).',
  'Heel: leather (40-60%), rubber (20-40%), plastic (10-30%).',
  'Template: leather (40-50%), foam (20-30%), fabric (10-20%).',
  'Instep: leather (40-60%), fabric (20-40%), before/suede (10-20%).',
  'Lining: leather (40-60%), fabric (20-30%).',
  'Laces: leather (30-50%), cotton (20-40%), nylon/polyester (10-20%).',
  'Eyes: metal (50-70%), plastic (20-40%).',
  'Seams: nylon/polyester thread (70-90%), cotton (10-30%).',
  'Reinforcements: leather (30-50%), plastic (20-30%), metal (10-20%).',
  'Ornaments: metal (30-50%), leather (20-40%), fabric (10-20%).',
];
